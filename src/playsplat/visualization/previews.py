...
def render_playability_summary_card(report_path: str | Path, output_path: str | Path) -> Path:
    ...
    rows = [
        ...
        ("semantic_status", metrics.get("semantic_status", "n/a")),
        ("affordance_status", metrics.get("affordance_status", "n/a")),
        ("semantic_label_count", metrics.get("semantic_label_count", "n/a")),
        ("affordance_label_count", metrics.get("affordance_label_count", "n/a")),
